...
2. Koje mjere složenosti riječi najviše utječu na brzinu rješavanja zadataka (npr. što će više otežati zadatak, ako riječ ima više slova ili ako ima više različitih značenja)?

```{r}
cor(english$Familiarity, english$WrittenFrequency)
plot(english$Familiarity, english$WrittenFrequency)
#korelacija i graf prepoznatljivosti riječi i njenog pojavljivanja u tekstovima iz čega se može iščitati da su poznatije riječi koje se više pojavljuju, ali se možda očekivalo da korelacija bude još i veća
